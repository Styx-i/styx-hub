...
const HeaderSlider = () => {
  const sliderData = [
    {
      id: 1,
      title: "Step Into Comfort - Explore Our Premium Sneaker Collection!",
    ...
    {
      id: 2,
      title: "Run in Style - Discover High-Performance Running Shoes!",
    ...
    {
      id: 3,
      title: "Elegance in Every Step - Premium Leather Shoes Just for You!",
